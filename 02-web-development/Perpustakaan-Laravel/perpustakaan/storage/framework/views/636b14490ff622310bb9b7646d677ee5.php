...
<div class="relative" x-data="{ open: false }" @click.outside="open = false" @close.stop="open = false">
    ...
    <div x-show="open"
         ...
         class="absolute z-50 bottom-full mb-2 <?php echo e($width); ?> rounded-md shadow-lg <?php echo e($alignmentClasses); ?>"
         style="display: none;"
         @click="open = false">
...
<?php /**PATH D:\matkul\semester 6\proyek mandiri\perpustakaan\resources\views/components/dropdown.blade.php ENDPATH**/ ?>
    ...
    <div class="bg-white p-6 rounded-2xl shadow-md overflow-x-auto">
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40 backdrop-blur-sm">
            <div class="bg-white rounded-xl shadow-lg w-full max-w-lg p-6 max-h-[90vh] overflow-y-auto">
                <h2 class="text-xl font-semibold mb-4"><?php echo e($isEdit ? 'Edit Guru' : 'Tambah Guru'); ?></h2>
...
<?php /**PATH D:\matkul\semester 6\proyek mandiri\perpustakaan\resources\views/livewire/admin/anggota/guru.blade.php ENDPATH**/ ?>